...
public sealed class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        string uri = this.Configuration.GetValue<string>(key: @"ServerOctopus:Url") ?? string.Empty;
        string apiKey = this.Configuration.GetValue<string>(key: @"ServerOctopus:ApiKey") ?? string.Empty;
