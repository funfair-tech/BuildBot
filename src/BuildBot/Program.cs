...
public static class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        using (IHost host = ServerStartup.CreateWebHost(args: args, httpPort: 49781, httpsPort: 0, h2Port: 0, configurationFiledPath: ApplicationConfigLocator.ConfigurationFilesPath))
        {
