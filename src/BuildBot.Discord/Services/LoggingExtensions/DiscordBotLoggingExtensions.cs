...
internal static partial class DiscordBotLoggingExtensions
{
    ...
    [LoggerMessage(
        EventId = 8,
        Level = LogLevel.Warning,
        Message = "DISCORD: WARNING: {message}"
    )]
    ...
    [LoggerMessage(
        ...
        Message = "DISCORD: CRITICAL ERROR: {message}"
    )]
    ...
    public static partial void DiscordCriticalError(this ILogger<DiscordBot> logger, string message, Exception exception);
}
