...
public sealed class CloudFormationSnsPropertiesParserTests : TestBase
{
    ...
    public void ParseLineWithoutKeyValueSeparator_ReturnsEntryWithEmptyValue()
    {
        ...
        Assert.Contains(expected: "PlainValue", collection: result.Keys, StringComparer.Ordinal);
    ...
    public void Parse()
    {
        ...
        Assert.Contains(expected: "StackId", collection: result.Keys, StringComparer.Ordinal);
        Assert.Contains(expected: "Timestamp", collection: result.Keys, StringComparer.Ordinal);
        Assert.Contains(expected: "EventId", collection: result.Keys, StringComparer.Ordinal);
    }
}
